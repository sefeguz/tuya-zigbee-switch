...
| 🟧 | ✔️ | 🇸 | 🔌 | 🛜 | **TL** | `_TZ3000_gsqxcwqr` <br> `TS0001` | [1-gang switch (Milfra _TZ3000_gsqxcwqr)](https://www.zigbee2mqtt.io/devices/TS0001_basic_1.html) |   |   | 1-gang Milfra on Tuya ZTU module (shares 6-button PCB with MODULE_YBJQJSUZ_TS0003 3-gang). GUESS to verify with hardware - single button assumed to be the middle channel of the 3-gang (C0), master set to same pin C0. Pinout S=C0 R=D2 I=C4i (= 3-gang ch2). If button/relay does not respond, likely alternative is ch1 (B6/B4/A1). | 
